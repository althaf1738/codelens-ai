...
- Tree-sitter (tree_sitter_languages) for AST extraction
- Qdrant for vector storage + dependency-aware retrieval
- SQLite for project/file/dependency metadata
- Gemini/OpenAI for embeddings; Gemini/OpenAI/Claude for generation, with local heuristic fallback
